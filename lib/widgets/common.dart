...
const verticalMargin128 = SizedBox(height: 128.0);
...
const horizontalPadding104 = EdgeInsets.symmetric(horizontal: 104.0);
...
// Divider
const divider = Divider(thickness: 1, color: CustomColors.fontSecondaryColor);
